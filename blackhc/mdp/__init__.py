...
class MDPEnv(gym.Env):
    ...
    def __init__(self, mdp: MDPSpec, start_state: State = None):
        ...
        self.start_state=self.mdp.states[0]
    ...
    def reset(self,i):
        ...
        # for x,y in zip(self.mdp.reward_outcomes.keys(),self.mdp.reward_outcomes.values()):
        #     print(x,y)
        # print(self.mdp.reward_outcomes)
        # print(self.transitions.next_states)
    ...
    def step(self, action_index):
        ...
        if not self._is_done:
            ...
            # for x,y in zip(self.mdp.reward_outcomes.keys(),self.mdp.reward_outcomes.values()):
            #     print(x,y) 
            # print(self.mdp.reward_outcomes[self._state, action])
            ...
            # reward=list(reward_probs.keys())[state_id]
